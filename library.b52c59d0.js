 ...
 * limitations under the License.
 */
function Wi(t){const e=[];for(const[n,i]of Object.entries(t))Array.isArray(i)?i.forEach((t=>{e.push(encodeURIComponent(n)+"="+encodeURIComponent(t))})):e.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return e.length?"&"+e.join("&"):""}function Vi(t){const e={};return t.replace(/^\?/,"").split("&").forEach((t=>{if(t){const[n,i]=t.split("=");e[decodeURIComponent(n)]=decodeURIComponent(i)}})),e}function Gi(t){const e=t.indexOf("?");if(!e)return"";const n=t.indexOf("#",e);return t.substring(e,n>0?n:void 0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Wh{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(t){yh(t.idToken,"internal-error"),yh(void 0!==t.idToken,"internal-error"),yh(void 0!==t.refreshToken,"internal-error");const e="expiresIn"in t&&void 0!==t.expiresIn?Number(t.expiresIn):function(t){const e=jh(t);return yh(e,"internal-error"),yh(void 0!==e.exp,"internal-error"),yh(void 0!==e.iat,"internal-error"),Number(e.exp)-Number(e.iat)}(t.idToken);this.updateTokensAndExpiration(t.idToken,t.refreshToken,e)}async getToken(t,e=!1){return yh(!this.accessToken||this.refreshToken,t,"user-token-expired"),e||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(t,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(t,e){const{accessToken:n,refreshToken:i,expiresIn:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function(t,e){const n=await Ph(t,{},(async()=>{const n=Wi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:r}=t.config,s=xh(t,i,"/v1/token",`key=${r}`),o=await t._getAdditionalHeaders();return o["Content-Type"]="application/x-www-form-urlencoded",Rh.fetch()(s,{method:"POST",headers:o,body:n})}));return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}(t,e);this.updateTokensAndExpiration(n,i,Number(r))}updateTokensAndExpiration(t,e,n){this.refreshToken=e||null,this.accessToken=t||null,this.expirationTime=Date.now()+1e3*n}static fromJSON(t,e){const{refreshToken:n,accessToken:i,expirationTime:r}=e,s=new Wh;return n&&(yh("string"==typeof n,"internal-error",{appName:t}),s.refreshToken=n),i&&(yh("string"==typeof i,"internal-error",{appName:t}),s.accessToken=i),r&&(yh("number"==typeof r,"internal-error",{appName:t}),s.expirationTime=r),s}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(t){this.accessToken=t.accessToken,this.refreshToken=t.refreshToken,this.expirationTime=t.expirationTime}_clone(){return Object.assign(new Wh,this.toJSON())}_performRefresh(){return _h("not implemented")}constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{static parseLink(t){const e=function(t){const e=Vi(Gi(t)).link,n=e?Vi(Gi(e)).deep_link_id:null,i=Vi(Gi(t)).deep_link_id;return(i?Vi(Gi(i)).link:null)||i||n||e||t}(t);try{return new Iu(e)}catch(t){return null}}constructor(t){var e,n,i,r,s,o;const a=Vi(Gi(t)),l=null!==(e=a.apiKey)&&void 0!==e?e:null,c=null!==(n=a.oobCode)&&void 0!==n?n:null,h=function(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(i=a.mode)&&void 0!==i?i:null);yh(l&&c&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=c,this.continueUrl=null!==(r=a.continueUrl)&&void 0!==r?r:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vu extends $u{_addListener(t,e){}_removeListener(t,e){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Vu.type="SESSION";const Gu=Vu;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(tg=Zf||(Zf={}))[tg.OVERWRITE=0]="OVERWRITE",tg[tg.MERGE=1]="MERGE",tg[tg.ACK_USER_WRITE=2]="ACK_USER_WRITE",tg[tg.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class ng{operationForChild(t){if(Zp(this.path)){if(null!=this.affectedTree.value)return li(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const e=this.affectedTree.subtree(new zp(t));return new ng(Wp(),e,this.revert)}}return li(Vp(this.path)===t,"operationForChild called for unrelated child."),new ng(Kp(this.path),this.affectedTree,this.revert)}constructor(t,e,n){this.path=t,this.affectedTree=e,this.revert=n,this.type=Zf.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ig{operationForChild(t){return Zp(this.path)?new ig(this.source,Wp(),this.snap.getImmediateChild(t)):new ig(this.source,Kp(this.path),this.snap)}constructor(t,e,n){this.source=t,this.path=e,this.snap=n,this.type=Zf.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rg{operationForChild(t){if(Zp(this.path)){const e=this.children.subtree(new zp(t));return e.isEmpty()?null:e.value?new ig(this.source,Wp(),e.value):new rg(this.source,Wp(),e)}return li(Vp(this.path)===t,"Can't get a merge for a child not on the path of the operation"),new rg(this.source,Kp(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(t,e,n){this.source=t,this.path=e,this.children=n,this.type=Zf.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sg{isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(t){if(Zp(t))return this.isFullyInitialized()&&!this.filtered_;const e=Vp(t);return this.isCompleteForChild(e)}isCompleteForChild(t){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(t)}getNode(){return this.node_}constructor(t,e,n){this.node_=t,this.fullyInitialized_=e,this.filtered_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dg;class pg{static fromObject(t){let e=new pg(null);return _p(t,((t,n)=>{e=e.set(new zp(t),n)})),e}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(t,e){if(null!=this.value&&e(this.value))return{path:Wp(),value:this.value};if(Zp(t))return null;{const n=Vp(t),i=this.children.get(n);if(null!==i){const r=i.findRootMostMatchingPathAndValue(Kp(t),e);if(null!=r){return{path:Qp(new zp(n),r.path),value:r.value}}return null}return null}}findRootMostValueAndPath(t){return this.findRootMostMatchingPathAndValue(t,(()=>!0))}subtree(t){if(Zp(t))return this;{const e=Vp(t),n=this.children.get(e);return null!==n?n.subtree(Kp(t)):new pg(null)}}set(t,e){if(Zp(t))return new pg(e,this.children);{const n=Vp(t),i=(this.children.get(n)||new pg(null)).set(Kp(t),e),r=this.children.insert(n,i);return new pg(this.value,r)}}remove(t){if(Zp(t))return this.children.isEmpty()?new pg(null):new pg(null,this.children);{const e=Vp(t),n=this.children.get(e);if(n){const i=n.remove(Kp(t));let r;return r=i.isEmpty()?this.children.remove(e):this.children.insert(e,i),null===this.value&&r.isEmpty()?new pg(null):new pg(this.value,r)}return this}}get(t){if(Zp(t))return this.value;{const e=Vp(t),n=this.children.get(e);return n?n.get(Kp(t)):null}}setTree(t,e){if(Zp(t))return e;{const n=Vp(t),i=(this.children.get(n)||new pg(null)).setTree(Kp(t),e);let r;return r=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new pg(this.value,r)}}fold(t){return this.fold_(Wp(),t)}fold_(t,e){const n={};return this.children.inorderTraversal(((i,r)=>{n[i]=r.fold_(Qp(t,i),e)})),e(t,this.value,n)}findOnPath(t,e){return this.findOnPath_(t,Wp(),e)}findOnPath_(t,e,n){const i=!!this.value&&n(e,this.value);if(i)return i;if(Zp(t))return null;{const i=Vp(t),r=this.children.get(i);return r?r.findOnPath_(Kp(t),Qp(e,i),n):null}}foreachOnPath(t,e){return this.foreachOnPath_(t,Wp(),e)}foreachOnPath_(t,e,n){if(Zp(t))return this;{this.value&&n(e,this.value);const i=Vp(t),r=this.children.get(i);return r?r.foreachOnPath_(Kp(t),Qp(e,i),n):new pg(null)}}foreach(t){this.foreach_(Wp(),t)}foreach_(t,e){this.children.inorderTraversal(((n,i)=>{i.foreach_(Qp(t,n),e)})),this.value&&e(t,this.value)}foreachChild(t){this.children.inorderTraversal(((e,n)=>{n.value&&t(e,n.value)}))}constructor(t,e=(()=>(dg||(dg=new mf(fp)),dg))()){this.value=t,this.children=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hg(t,e,n,i,r){const s=new Bg;let o,a;if(n.type===Zf.OVERWRITE){const l=n;l.source.fromUser?o=Wg(t,e,l.path,l.snap,i,r,s):(li(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered()&&!Zp(l.path),o=zg(t,e,l.path,l.snap,i,r,a,s))}else if(n.type===Zf.MERGE){const l=n;l.source.fromUser?o=function(t,e,n,i,r,s,o){let a=e;return i.foreach(((i,l)=>{const c=Qp(n,i);Vg(e,Vp(c))&&(a=Wg(t,a,c,l,r,s,o))})),i.foreach(((i,l)=>{const c=Qp(n,i);Vg(e,Vp(c))||(a=Wg(t,a,c,l,r,s,o))})),a}(t,e,l.path,l.children,i,r,s):(li(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered(),o=Kg(t,e,l.path,l.children,i,r,a,s))}else if(n.type===Zf.ACK_USER_WRITE){const a=n;o=a.revert?function(t,e,n,i,r,s){let o;if(null!=Dg(i,n))return e;{const a=new qg(i,e,r),l=e.eventCache.getNode();let c;if(Zp(n)||".priority"===Vp(n)){let n;if(e.serverCache.isFullyInitialized())n=Lg(i,ug(e));else{const t=e.serverCache.getNode();li(t instanceof Df,"serverChildren would be complete if leaf node"),n=Og(i,t)}c=t.filter.updateFullNode(l,n,s)}else{const r=Vp(n);let h=Mg(i,r,e.serverCache);null==h&&e.serverCache.isCompleteForChild(r)&&(h=l.getImmediateChild(r)),c=null!=h?t.filter.updateChild(l,r,h,Kp(n),a,s):e.eventCache.getNode().hasChild(r)?t.filter.updateChild(l,r,Df.EMPTY_NODE,Kp(n),a,s):l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Lg(i,ug(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,s)))}return o=e.serverCache.isFullyInitialized()||null!=Dg(i,Wp()),lg(e,c,o,t.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
