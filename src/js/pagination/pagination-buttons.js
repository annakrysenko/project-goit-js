...
if (totalPages > 9) {
    if (currentPage === 1) {
        ...
        <button class="pgn-btn first-number" type="button">1</button>
        <span class="pgn-dots">...</span>
        <button class="pgn-btn pgn-mobbile" type="button">${currentPage - 3}</button>
        <button class="pgn-btn pgn-mobbile" type="button">${currentPage - 2}</button>
        <button class="pgn-btn" type="button">${currentPage - 1}</button>
        <button class="pgn-current pgn-btn" type="button" disabled>${currentPage}</button>
        <button class="pgn-btn" type="button">${totalPages}</button>
        <button class="pgn-btn next" type="button">
        ...
        <button class="pgn-btn first-number" type="button">1</button>
        <span class="pgn-dots">...</span>
        <button class="pgn-btn pgn-mobbile" type="button">${totalPages - 3}</button>
        <button class="pgn-btn" type="button">${totalPages - 2}</button>
        <button class="pgn-btn" type="button">${totalPages - 1}</button>
        <button class="pgn-current pgn-btn" type="button" disabled>${currentPage}</button>`
    }
